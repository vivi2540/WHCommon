...
- (void)delegate:(PYPhotosView *)photosView didAddImageClickedWithImages:(NSMutableArray *)images;
/** 
 * 图片未发布时进入浏览图片时调用此方法
...
@property (nonatomic, assign)BOOL isHiddenDele;
@property (nonatomic, assign)BOOL DoNotEdit;
