...
//        _childImageView = [[UIImageView alloc] init];
//        _childImageView.clipsToBounds = YES;
//        _childImageView.layer.cornerRadius = 5;
//        _childImageView.py_size = CGSizeMake(64*WIDTHSCALE, 64*WIDTHSCALE);
//        _childImageView.userInteractionEnabled = YES;
//        [self addSubview:_childImageView];
        ...
        deleteImageView.py_size = CGSizeMake(20, 20);
...
-(void)setDoNotEdit:(BOOL)DoNotEdit {
    _DoNotEdit = DoNotEdit;
...
- (void)setImage:(UIImage *)image
{
    ...
    NSLog(@"里面--%f,%f",image.size.width,image.size.height);
...
//    [self.childImageView setImage:image];
    ...
    NSLog(@"self.py_size--%f,%f",self.py_size.width,self.py_size.height);
...
- (void)deleteImage
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"ChangeImageArrs" object:self userInfo:@{@"images":self.images}];
}
...
- (void)layoutSubviews
{
    ...
    // 设置删除图片位置
//    self.deleteImageView.py_x = self.py_width - self.deleteImageView.py_width/2 - 5;
//    self.deleteImageView.py_y = - self.deleteImageView.py_height/2 + 5;
    
        self.deleteImageView.py_x = self.py_width - self.deleteImageView.py_width/2 - 10;
        self.deleteImageView.py_y = - self.deleteImageView.py_height/2 + 10;
    
//    [self layoutIfNeeded];
//    [self.childImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
//        make.width.height.offset(64*WIDTHSCALE);
