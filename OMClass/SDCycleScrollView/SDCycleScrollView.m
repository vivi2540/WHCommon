...
- (void)setupMainView
{
    ...
    _labelss = [[UILabel alloc]init];
    _labelss.layer.cornerRadius = 10;
    _labelss.clipsToBounds = YES;
    _labelss.textAlignment = NSTextAlignmentCenter;
    _labelss.backgroundColor = [UIColor colorWithWhite:0 alpha:0.6];
    _labelss.textColor = [UIColor whiteColor];
    _labelss.font = PFSC_RegularFont(10);
    [self addSubview:_labelss];
    [_labelss mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setupPageControl
{
    ...
    _labelss.text = [NSString stringWithFormat:@"1/%ld",self.imagePathsGroup.count];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    _labelss.text = [NSString stringWithFormat:@"%d/%ld",indexOnPageControl + 1,self.imagePathsGroup.count];
}
