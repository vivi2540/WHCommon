...
+ (void)showAutoMessage:(NSString *)msg{
    UIView *view = (UIView*)[[UIApplication sharedApplication].windows lastObject];
    [MBProgressHUD showTitleToView:view
                           postion:NHHUDPostionCenten
                      contentStyle:NHHUDContentBlackStyle
                             title:msg];
}


+ (void)showAutoHidenTitleToView:(UIView *)view title:(NSString *)title{
    if (view == nil) view = (UIView*)[UIApplication sharedApplication].delegate.window;
    [MBProgressHUD showTitleToView:view
                           postion:NHHUDPostionCenten
                      contentStyle:NHHUDContentBlackStyle
