...
//    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[IWColor(48, 159, 217) CGColor],(id)[IWColor(166, 234, 240) CGColor], nil]];
    ...
    if (self.isManji) {
        [gradientLayer setColors:[NSArray arrayWithObjects:(id)[NSString colorWithHexString:@"#3379FF"].CGColor,(id)[NSString colorWithHexString:@"#3379FF"].CGColor, nil]];
    }else {
        [gradientLayer setColors:[NSArray arrayWithObjects:(id)[NSString colorWithHexString:@"#3379FF"].CGColor,(id)[NSString colorWithHexString:@"#8A20FF"].CGColor, nil]];
    }
...
//    [self.scoreLB countFrom:0 to:9 withDuration:5 * 9/100.0];
    [self.scoreLB countFrom:0 to:self.num withDuration:self.num * 9/100.0];
...
- (YDCountLabel *)scoreLB
{
    if (!_scoreLB) {
        ...
        _scoreLB.format = @"%d";
        _scoreLB.font = PFSC_MediumFont(25);
...
//        _scoreLB.textColor = IWColor(48, 159, 217);
        _scoreLB.textColor = [NSString colorWithHexString:@"#0B0C26"];
