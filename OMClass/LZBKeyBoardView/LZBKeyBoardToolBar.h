 ...
 */
+ (LZBKeyBoardToolBar *)showKeyBoardWithConfigToolBarHeight:(CGFloat)toolBarHeight sendTextCompletion:(void(^)(NSString *sendText))sendTextBlock keyBoadrdCompletion:(void(^)(NSNotification *notification ,BOOL isShow,CGFloat offsetMarginY,CGFloat animationDuration))keyBoadrdCompletion;
