...
#define windowContentWidth  ([[UIScreen mainScreen] bounds].size.width - 24)
...
//        self.layer.shadowOpacity=.2;
        ...
        _titles=titleArray;
        _defaultIndex=1;
        _titleFont=PFSC_RegularFont(15);
        _btns=[[NSMutableArray alloc] initWithCapacity:0];
        _titleNomalColor=kTextGay9Clor;
        _titleSelectColor=OMBlue_COLOR;
        ...
        _selectLine=[[UIView alloc] initWithFrame:CGRectMake(_btn_w/4, self.frame.size.height-2, _btn_w/2, 2)];
...
-(void)btnClick:(UIButton *)btn{
    ...
    [UIView animateWithDuration:.2 animations:^{
        ...
        _selectLine.frame=CGRectMake(btn.frame.origin.x+btn.frame.size.width/4, self.frame.size.height-2, btn.frame.size.width/2, 2);
