...
- (instancetype)initWithDelegate:(id<JXPageListViewDelegate>)delegate tableViewStyle:(UITableViewStyle)tableViewStyle {
    self = [super initWithFrame:CGRectZero];
    if (self) {
        _delegate = delegate;
        [self initializeViews:tableViewStyle];
    }
    return self;
}
...
- (instancetype)initWithDelegate:(id<JXPageListViewDelegate>)delegate{
    ...
    if (self) {
        _delegate = delegate;
        [self initializeViews:UITableViewStylePlain];
    }
    return self;
}

- (void)initializeViews:(UITableViewStyle)tableViewStyle {
    ...
    _mainTableView = [[JXPageListMainTableView alloc] initWithFrame:CGRectZero style:tableViewStyle];
