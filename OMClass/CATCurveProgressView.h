...
-(void)gradientProgressView:(OMGradientProgressView *)progressView progressChanged:(CGFloat)progress lastProgress:(CGFloat)lastProgress;
...
@interface OMGradientProgressView : UIView
